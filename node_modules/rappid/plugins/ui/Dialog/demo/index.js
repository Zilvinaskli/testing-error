...
$('#btn-center-position').on('click', function() {

    var dialog = new joint.ui.Dialog({
        width: 420,
        title: 'Centered button',
        content: '<img width=400 height=267 src="./images/amsterdam1.jpg"></img>',
        buttons: [
            { action: 'download', content: 'Download', position: 'center' },
        ]
    }).open();

    dialog.on('action:download', dialog.close, dialog);
});
