...
export const TreeLayoutView = mvc.View.extend({
    ...
    render: function() {
        ...
        var paperOptions = util.assign({}, this.options.paperOptions, {
            interactive: false,
            width: '100%',
            height: '100%'
        });
    ...
    _startDrag: function(elements, x, y) {
        ...
        this.updateBox(this.$translateBox, util.defaults({ x: x, y: y }, bbox));
    ...
    _doDrag: function(elements, x, y) {
        ...
        if (layoutArea) {
            ...
            var isConnectionValid = util.toArray(elements).every(function(item) {
