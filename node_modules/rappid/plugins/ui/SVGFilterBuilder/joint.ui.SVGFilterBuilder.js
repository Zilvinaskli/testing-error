...
(function(joint) {
    ...
    joint.ui.SVGFilterBuilder = joint.mvc.View.extend({
        ...
        init: function() {
            ...
            this.paper = new joint.dia.Paper({
                ...
                validateConnection: function(sourceView, sourceMagnet, targetView, targetMagnet, end, linkView) {
                    ...
                    var hasCycle = this.model.getSuccessors(targetView.model).find(function(cell) {
                    ...
                    var portUsage = this.model.getLinks().find(function(link) {
            ...
            this.fio = new SVGFilterIO(this.sourceLayers, function() {
        ...
        initializeKeyboardShortcuts: function() {
            ...
            this.keyboard.on({
                ...
                'ctrl+c': function() {
                    ...
                    var nonStatic = this.selection.collection.filter(function(element) {
                ...
                'ctrl+v': function() {
                    ...
                    var elements = pastedCells.filter(function(cell) {
        ...
        getSourceLayers: function() {
            ...
            sourceInputs.forEach(function(item, index) {
        ...
        connectResult: function() {
            ...
            var sinks = joint.util.difference(this.graph.getSinks(), this.sourceLayers);
        ...
        layout: function() {
            ...
            var sources = this.graph.getCells().filter(function(item) {
        ...
        showImportDialog: function(type) {
            ...
            dialog.on('action:submit', function(content) {
        ...
        dummyDfs: function(element, iteratee, opt, _distance) {
            ...
            this.graph.getNeighbors(element, opt).forEach(function(neighbor) {
        ...
        processGraph: function() {
            ...
            this.dummyDfs(start, function(element, distance) {

                if (element.get('type').includes('filter.')) {
            ...
            }.bind(this), { inbound: true });

            var sortedFilterMap = joint.util.sortBy(filterMap, function(item) {
                return -item[0];
            });

            sortedFilterMap.forEach(function(item) {
                filters.push(item[1]);
            });
    ...
    SvgDom.prototype = {
        ...
        findByTagName: function($content, tags, result) {
            ...
            $content.each(function(index, value) {
                ...
                $filterElement.children().each(function(index, item) {
        ...
        convertElementToMarkup: function(data) {
            ...
            var attrs = [''];
            if (data.attrs) {
                joint.util.forIn(data.attrs, function(value, key) {
                    if (value) {
    ...
    var ImportFilterDialog = joint.mvc.View.extend({
        ...
        validate: function($okButton, $info) {
            ...
            if (content['filter'].length >= 1) {
                ...
                joint.util.forIn(content['filter'], function(filter) {
        ...
        bindEvents: function($source, $ok, $info) {
            ...
            $source.bind('blur paste keydown', function() {
    ...
    var FilterPreview = joint.mvc.View.extend({
        ...
        setShape: function(markup) {
            this.markup = joint.util.isString(markup) ? markup : this.resolveShapeContent(markup);
            this.update();
        },
        ...
        exportFilter: function() {
            ...
            var filtersMarkups = [];
            this.filterData.forEach(function(filter) {
    ...
    var DropOverlay = joint.mvc.View.extend({
        ...
        init: function() {
            ...
            joint.util.bindAll(this, 'handleDragOver', 'handleFileSelect', 'handleDragLeave', 'handleDragOverDropZone');
        },
        ...
        render: function() {
            ...
            dropZonesDef.forEach(function(item) {
                var element = $('<div/>')
                    .addClass('drop-zone')
    ...
    SVGFilterIO.prototype = {
        ...
        markupToCells: function(markup) {
            ...
            filterParts.each(function(index, value) {
            ...
            joint.util.toArray(this.sources).forEach(function(cell) {
        ...
        createLinks: function(cellsMap) {
            ...
            var links = [];
            joint.util.forIn(cellsMap, function(value) {
                var cell = value.cell;
