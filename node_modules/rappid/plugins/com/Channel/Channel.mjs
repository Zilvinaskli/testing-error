...
export const Channel = function(opt) {
    ...
    // This site ID.
    this.id = this.options.id || (this._isClient ? 'c_' : 's_') + util.uuid();
...
util.assign(Channel.prototype, Backbone.Events);
...
Channel.prototype.close = function() {
    ...
    util.forIn(this.sites, function(site) {
...
Channel.prototype.healthCheck = function() {
    ...
    util.forIn(this.sites, function(site, channelId) {
        ...
        if (site.ttl <= 0) {
            ...
            this.sites = util.omit(this.sites, channelId);
            this.state = util.omit(this.state, channelId);
        }
...
Channel.prototype.broadcast = function(message) {
    ...
    if (this._isClient) {
        ...
        message.target = Object.keys(util.omit(this.sites, this.id, message.source));
    }
...
export const ChannelHub = function(opt) {
...
util.assign(ChannelHub.prototype, Backbone.Events);
