...
window.channel1 = new joint.com.Channel({ graph: graph1, url: channelHubUrl, query: { room: 'A' }});
window.channel2 = new joint.com.Channel({ graph: graph2, url: channelHubUrl, query: { room: 'A' }});
window.channel3 = new joint.com.Channel({ graph: graph3, url: channelHubUrl, query: { room: 'B' }});
window.channel4 = new joint.com.Channel({ graph: graph4, url: channelHubUrl, query: { room: 'B' }});
