...
(function (exports, $, core_mjs) {
    ...
    var PathEditor = core_mjs.mvc.View.extend({
        ...
        _transformPoint: function(x, y, matrix) {
            ...
            return core_mjs.V.transformPoint(core_mjs.g.Point(x, y), matrix);
        },
        ...
        adjustControlPoint: function(index, controlPointIndex, dx, dy) {
            ...
            if (controlPt.hasClass('locked')) {
                ...
                var center = core_mjs.g.point(((controlPointIndex == 1) ? bindSeg.x : seg.x), ((controlPointIndex == 1) ? bindSeg.y : seg.y));
                var controlPos = core_mjs.g.point(seg[xA], seg[yA]);
                var distance = center.distance(core_mjs.g.Point(bindSeg[xB], bindSeg[yB]));
        ...
        createAnchorPoint: function(e) {
            ...
            var pt = core_mjs.V(pathNode).toLocalPoint(evt.pageX, evt.pageY);
            var seg = segList.getItem(index);
            ...
            switch (seg.pathSegType) {
                ...
                case SVGPathSeg.PATHSEG_CURVETO_CUBIC_ABS:
                    ...
                    var p0 = core_mjs.g.point(pseg.x, pseg.y);
                    var p1 = core_mjs.g.point(seg.x1, seg.y1);
                    var p2 = core_mjs.g.point(seg.x2, seg.y2);
                    var p3 = core_mjs.g.point(seg.x, seg.y);

                    // Inversion of Bezier curve
                    var t = core_mjs.g.bezier.getInversionSolver(p0, p1, p2, p3)(pt);

                    // TODO: wen a curve is a straight line we will get inaccurate results
                    if (t < 0) { return; }

                    // Divide a Bezier curve into two
                    var curves = core_mjs.g.bezier.getCurveDivider(p0, p1, p2, p3)(t);
