...
(function (exports, core_mjs) {
    ...
    var GridLayout = {
        ...
        layout: function(graphOrCells, opt) {
            ...
            if (graphOrCells instanceof core_mjs.dia.Graph) {
                graph = graphOrCells;
            } else {
                ...
                graph = (new core_mjs.dia.Graph()).resetCells(graphOrCells, { dry: true, sort: false });
            }
            ...
            if (columnWidth === 'compact') {
                ...
                if (!columnWidth || core_mjs.util.isString(columnWidth)) {
            ...
            if (rowHeight === 'compact') {
                ...
                if (!rowHeight || core_mjs.util.isString(rowHeight)) {
...
}(this.joint.layout = this.joint.layout || {}, joint));
