...
(function (exports, $, core_mjs) {
    ...
    var Tooltip = core_mjs.mvc.View.extend({
        ...
        init: function() {
            ...
            core_mjs.util.bindAll(this, 'render', 'hide', 'show', 'toggle', 'isVisible', 'position');
        ...
        render: function(evt) {
            ...
            var point = evt.x !== undefined && evt.y !== undefined ? evt : null;
            ...
            if (point) {
                ...
                targetBBox = core_mjs.util.getElementBBox(element);
            }
        ...
        evaluateOptions: function(element, elementDefinition) {
            ...
            var settings = core_mjs.util.assign({}, elementDefinition, this.options);

            core_mjs.util.forIn(settings, function(value, key) {
                var evaluated = core_mjs.util.isFunction(value) ? value(element) : value;
        ...
        loadDefinitionFromElementData: function(element) {
            ...
            core_mjs.util.forIn(data, function(value, key) {
        ...
        getAllAttrs: function(element, namePrefix) {
            ...
            for (var i = 0, n = attrs.length; i < n; i++) {
                ...
                if (attr && attr.name.startsWith(prefix)) {
                    var name = core_mjs.util.camelCase(attr.name.slice(prefix.length));
        ...
        position: function(targetBBox) {
            ...
            var containerBBox = core_mjs.util.getElementBBox(this.container);
        ...
        getViewportViewBBox: function() {
            ...
            var viewportBBox = core_mjs.util.getElementBBox(el);
        ...
        getTooltipBBox: function(targetBBox, containerBBox) {
            ...
            var positionedBBox = $element[0] ? core_mjs.util.getElementBBox($element[0]) : targetBBox;
