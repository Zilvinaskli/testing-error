...
(function (exports, $, basic_mjs, core_mjs) {
    ...
    var PlotView = core_mjs.dia.ElementView.extend({
        ...
        renderBar: function(p, serie) {
            ...
            elBar.attr({
                ...
                'data-x': p.x,
                'data-y': p.y,
                d: core_mjs.V.rectToPath({ x: barX, y: y, width: barWidth, height: barHeight, 'top-rx': topRx, 'top-ry': topRy, 'bottom-rx': bottomRx, 'bottom-ry': bottomRy })
            });
        ...
        updateMarkings: function() {
            ...
            core_mjs.util.toArray(markings).forEach(function(marking, i) {
                ...
                elMarking.attr(core_mjs.util.assign({ 'class': className }, marking.attrs));
        ...
        showGuidelines: function(clientX, clientY, evt) {
            ...
            if (core_mjs.g.rect(bbox).containsPoint(localPoint)) {
                ...
                core_mjs.V(this.elXGuideline).attr({ x1: x, y1: 0, x2: x, y2: size.height, visibility: 'visible' });
                core_mjs.V(this.elYGuideline).attr({ x1: 0, y1: y, x2: size.width, y2: y, visibility: 'visible' });
    ...
    var Pie = basic_mjs.Generic.extend({
        ...
        addSlice: function(slice, serieIndex, opt) {
            ...
            opt = serie.data.length > 1 ? core_mjs.util.assign(opt, { changedSerieIndex: serieIndex }) : opt;
        ...
        editSlice: function(slice, sliceIndex, serieIndex, opt) {
            ...
            this.set('series', series, core_mjs.util.assign(opt, { changedSerieIndex: serieIndex }));
        }
    });
