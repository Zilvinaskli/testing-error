...
(function (exports, $, core_mjs) {
    ...
    var FreeTransform = core_mjs.mvc.View.extend({
        ...
        init: function() {
            ...
            core_mjs.util.bindAll(this, 'update', 'remove', 'pointerup', 'pointermove');
        ...
        renderHandles: function() {
            ...
            var $resizeHandles = this.POSITIONS.map(function(position) {
        ...
        update: function() {
            ...
            var angle = core_mjs.g.normalizeAngle(this.options.cell.get('angle') || 0);
        ...
        startResizing: function(evt) {
            ...
            this._initial = {
                angle: core_mjs.g.normalizeAngle(this.options.cell.get('angle') || 0),
        ...
        startRotating: function(evt) {
            ...
            this._initial = {
                ...
                modelAngle: core_mjs.g.normalizeAngle(this.options.cell.get('angle') || 0),
                // an angle between the line starting at mouse coordinates, ending at the center of rotation
                // and y-axis
                startAngle: core_mjs.g.point(clientCoords).theta(center)
            };
        ...
        pointermove: function(evt) {
            ...
            switch (this._action) {
                ...
                case 'resize':
                    ...
                    var coimageCoords = core_mjs.g.point(clientCoords).rotate(currentRect.center(), i.angle);
                    ...
                    // Fitting into a grid
                    width = core_mjs.g.snapToGrid(width, gridSize);
                    height = core_mjs.g.snapToGrid(height, gridSize);
                    // Minimum
                ...
                case 'rotate':
                    ...
                    var theta = i.startAngle - core_mjs.g.point(clientCoords).theta(i.centerRotation);

                    model.rotate(core_mjs.g.snapToGrid(i.modelAngle + theta, options.rotateAngleGrid), true);
                    break;
            }
        },
        ...
        removeInstancesForPaper: function(paper) {
            ...
            core_mjs.util.invoke(this.getInstancesForPaper(paper), 'remove');
        },
    ...
    exports.FreeTransform = FreeTransform;
