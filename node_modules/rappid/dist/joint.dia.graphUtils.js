...
(function (core_mjs, Dijkstra_mjs) {
    'use strict';
    ...
    core_mjs.dia.Graph.prototype.constructTree = function(parent, opt, parentElement, collector) {

        collector = collector || [];

        var children = core_mjs.util.isFunction(opt.children) ? opt.children(parent) : parent[opt.children || 'children'];
        ...
        core_mjs.util.toArray(children).forEach(function(child) {
    ...
    core_mjs.dia.Graph.prototype.shortestPath = function(source, target, opt) {
        ...
        var previous = Dijkstra_mjs.Dijkstra(adjacencyList, source.id || source, opt.weight);
