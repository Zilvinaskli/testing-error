    ...
    var Selection = core_mjs.mvc.View.extend({
        ...
        init: function() {
            ...
            if (this.options.paper) {
                ...
                core_mjs.util.defaults(this.options, { graph: this.options.paper.model });
            } else {
        ...
        changeHandle: function(name, opt) {
            ...
            if (handle) {
                ...
                this.addHandle(core_mjs.util.merge({ name: name }, handle, opt));
            }
        ...
        startRotating: function(evt) {
            ...
            var initialAngles = this.model.toArray().reduce(function(res, element) {
                res[element.id] = core_mjs.g.normalizeAngle(element.get('angle') || 0);
                return res;
            }, {});

            this.eventData(evt, {
                center: center,
                clientAngle: core_mjs.g.point(clientCoords).theta(center),
        ...
        startResizing: function(evt) {
            ...
            var elBBoxes = core_mjs.util.invoke(elements, 'getBBox');
        ...
        doRotate: function(evt) {
            ...
            if (Math.abs(theta) > 1e-3) {
                ...
                this.collection.each(function(element) {
                    var newAngle = core_mjs.g.snapToGrid(data.initialAngles[element.id] + theta, angleGrid);
