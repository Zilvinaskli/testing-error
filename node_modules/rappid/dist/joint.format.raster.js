...
(function (exports, core_mjs, svg_mjs) {
    'use strict';
     ...
     */
    var toDataURL = function(paper, callback, opt) {
        if ( opt === void 0 ) opt = {};
        ...
        /* global canvg:true */
        var canvgUtil = opt.canvg || (typeof canvg !== 'undefined' ? canvg : undefined);
        /* global canvg:false */

        var clientRect = opt.area || paper.paperToLocalRect(paper.getContentBBox());
        var svgViewBox = createSVGViewBox(clientRect, opt);

        var dimensions = (core_mjs.util.isNumber(opt.width) && core_mjs.util.isNumber(opt.height)) ? opt : svgViewBox;
        ...
        img.onload = function() {
            ...
            function stopTimer() {
                if (canvas.svg && core_mjs.util.isFunction(canvas.svg.stop)) {
            ...
            try {
                ...
                canvgUtil(canvas, svg, core_mjs.util.assign(canvgOpt, {
                    ...
                    renderCallback: function() {
                        ...
                        try {
                            ...
                            canvgUtil(canvas, svg, core_mjs.util.assign(canvgOpt, { renderCallback: readCanvas }));
                        }
                    }
                }));
            }
        ...
        svg_mjs.toSVG(paper, function(svgString) {
     ...
     * @param {Object} opt
     */
    var toPNG = function(paper, callback, opt) {
     ...
     * @param {Object} opt
     */
    var toJPEG = function(paper, callback, opt) {
     ...
     * @param paper
     */
    var openAsPNG = function(paper, opt) {

        var windowFeatures = 'menubar=yes,location=yes,resizable=yes,scrollbars=yes,status=yes';
        var windowName = core_mjs.util.uniqueId('png_output');
        ...
        }, core_mjs.util.assign({ padding: 10 }, opt));
    };
    ...
    function createSVGViewBox(clientBox, opt) {
        ...
        var paddingBox = core_mjs.g.rect({
            x: -padding.left,
            y: -padding.top,
        ...
        return core_mjs.g.Rect(clientBox).moveAndExpand(paddingBox);
    }
    ...
    function getPadding(opt) {
        ...
        var padding = core_mjs.util.normalizeSides(opt.padding);
        if (opt.width && opt.height) {
    ...
    core_mjs.dia.Paper.prototype.openAsPNG = function(opt) {
        var i = arguments.length, argsArray = Array(i);
        while ( i-- ) argsArray[i] = arguments[i];

        return openAsPNG.apply(this, [this ].concat( argsArray));
    };

    core_mjs.dia.Paper.prototype.toJPEG = function(callback, opt) {
        var i = arguments.length, argsArray = Array(i);
        while ( i-- ) argsArray[i] = arguments[i];

        return toJPEG.apply(this, [this ].concat( argsArray));
    };

    core_mjs.dia.Paper.prototype.toPNG = function(callback, opt) {
        var i = arguments.length, argsArray = Array(i);
        while ( i-- ) argsArray[i] = arguments[i];

        return toPNG.apply(this, [this ].concat( argsArray));
    };

    core_mjs.dia.Paper.prototype.toDataURL = function(callback, opt) {
        var i = arguments.length, argsArray = Array(i);
        while ( i-- ) argsArray[i] = arguments[i];

        return toDataURL.apply(this, [this ].concat( argsArray));
    };

    exports.openAsPNG = openAsPNG;
    exports.toDataURL = toDataURL;
    exports.toJPEG = toJPEG;
    exports.toPNG = toPNG;

}(this.joint.format = this.joint.format || {}, joint, joint.format));
