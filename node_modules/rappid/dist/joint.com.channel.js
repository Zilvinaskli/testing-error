...
(function (exports, Backbone, core_mjs) {
    ...
    var Channel = function(opt) {
        ...
        // This site ID.
        this.id = this.options.id || (this._isClient ? 'c_' : 's_') + core_mjs.util.uuid();
    ...
    core_mjs.util.assign(Channel.prototype, Backbone.Events);
    ...
    Channel.prototype.connectClient = function() {
    ...
    Channel.prototype.close = function() {
        ...
        core_mjs.util.forIn(this.sites, function(site) {
    ...
    Channel.prototype.healthCheck = function() {

        if (this.options.debugLevel > 0) {

            var message = Object.keys(this.sites).reduce(function(res, site) {
        ...
        core_mjs.util.forIn(this.sites, function(site, channelId) {
            ...
            if (site.ttl <= 0) {
                ...
                this.sites = core_mjs.util.omit(this.sites, channelId);
                this.state = core_mjs.util.omit(this.state, channelId);
            }
    ...
    Channel.prototype.onConnection = function(socket, message) {
        ...
        if (this._isClient) {
            ...
            // backward compatibility with ws pre v3.0
            var evt = socket.upgradeReq || message;
            // The required query fields from clients are `channelId` and `state` object JSON stringified.
            var upgradeReqUrl = url.parse(evt.url, true);
    ...
    Channel.prototype.onClose = function(socket) {
    ...
    // Remote update.
    Channel.prototype.onMessage = function(socket, message) {
    ...
    Channel.prototype.receive = function(site, channelId, op) {
    ...
    Channel.prototype.transform = function(o1, o2) {
    ...
    Channel.prototype.execute = function(op) {
    ...
    Channel.prototype.broadcast = function(message) {
        ...
        if (this._isClient) {
            ...
            message.target = Object.keys(core_mjs.util.omit(this.sites, this.id, message.source));
        }
    ...
    Channel.prototype.sendMessage = function(m) {
    ...
    Channel.prototype.log = function(keyword, args) {
    ...
    Channel.prototype.notify = function(event, data) {
    ...
    Channel.prototype.sendNotification = function(message) {
    ...
    Channel.prototype.onGraphChange = function(eventName, cell, graph, options) {
    ...
    core_mjs.util.assign(ChannelHub.prototype, Backbone.Events);
    ...
    ChannelHub.prototype.onConnection = function(socket, message) {
        ...
        var channel = this.router(req, function(error, channel) {
            ...
            if (channel && !called) {
                channel.onConnection(socket, message);
                called = true;
            }
        });
    ...
    ChannelHub.prototype.route = function(router) {

        this.router = router;
    };

    // Shut down the server.
    ChannelHub.prototype.close = function() {

        this.server.close();
    };

    exports.Channel = Channel;
    exports.ChannelHub = ChannelHub;

}(this.joint.com = this.joint.com || {}, Backbone, joint));
