...
(function (exports, $, core_mjs) {
    ...
    var Snaplines = core_mjs.mvc.View.extend({
        ...
        render: function() {
            ...
            var $h = this.$horizontal = $('<div>').addClass('snapline horizontal');
            var $v = this.$vertical = $('<div>').addClass('snapline vertical');

            this.$el.hide().append([$h, $v]).appendTo(this.options.paper.el);
        },
