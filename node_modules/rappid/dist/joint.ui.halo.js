...
(function (exports, $, core_mjs) {
    ...
    ElementHalo.prototype.startForking = function(evt, x, y) {
        ...
        if (!(clone instanceof core_mjs.dia.Cell)) {
    ...
    ElementHalo.prototype.startCloning = function(evt, x, y) {
        ...
        var cloneView = clone.findView(options.paper);
        cloneView.pointerdown(evt, x, y);
        this.eventData(evt, { cloneView: cloneView });
    };
    ...
    ElementHalo.prototype.makeLoopLink = function(link) {
        ...
        var paperRect = core_mjs.g.rect({ x: 0, y: 0, width: paperOpt.width, height: paperOpt.height });
    ...
    var Halo = core_mjs.mvc.View.extend({
        ...
        getBBox: function() {
            ...
            rect = core_mjs.util.defaults({}, rect, { x: 0, y: 0, width: 1, height: 1 });
        ...
        renderHandle: function(opt) {
            ...
            switch (this.options.type) {
                ...
                case 'pie':
                    ...
                    var svgTextIcon = core_mjs.V('text', { 'font-size': iconSize }).attr(iconPosition).addClass('slice-text-icon');
