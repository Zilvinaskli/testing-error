...
(function (exports, $, core_mjs) {
    ...
    var toSVG = function(paper, callback, opt) {
        ...
        var viewportBBox = opt.area || paper.paperToLocalRect(paper.getContentBBox());
        ...
        if (opt.useComputedStyles !== false) {
            ...
            copyExternalStyles(paper.svg, exportSVG.node);
        }
        ...
        if (opt.convertImagesToDataUris) {
            ...
            var exportImages = exportSVG.find('image');
            var deffereds = exportImages.map(convertImage);
    ...
    function addExternalStyles(toNode, styles) {
        ...
        core_mjs.V(toNode).prepend(core_mjs.V('style', { type: 'text/css' }, [
    ...
    var openAsSVG = function(paper, opt) {
        ...
        }, core_mjs.util.assign({ convertImagesToDataUris: true }, opt));
    };
    ...
    core_mjs.dia.Paper.prototype.toSVG = function() {
        ...
        return toSVG.apply(this, [this ].concat( argsArray));
    };
    ...
    core_mjs.dia.Paper.prototype.openAsSVG = function() {
        ...
        return openAsSVG.apply(this, [this ].concat( argsArray));
    };
